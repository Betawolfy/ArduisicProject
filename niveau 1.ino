...
void loop()
{
  ...
  if (digitalRead(A0) == HIGH) {
    tone(8, 65.41, 100); // play tone 57 (A4 = 440 Hz)
  }
  // if button press on A1 is detected
  if (digitalRead(A1) == HIGH) {
    tone(8, 73.42, 100); // play tone 59 (B4 = 494 Hz)
  }
  // if button press on A0 is detected
  if (digitalRead(A2) == HIGH) {
    tone(8, 82.41, 100); // play tone 60 (C5 = 523 Hz)
  }
  if (digitalRead(A3) == HIGH) {
    tone(8, 98, 100); // play tone 62 (D5 = 587 Hz)
  }
  if (digitalRead(A4) == HIGH) {
    tone(8, 110, 100); // play tone 63 (D#5 = 622 Hz)
  }
